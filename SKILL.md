---
name: gzlab-ppt-skills
description: >
  Create native PowerPoint decks from documents, topics, and structured source
  material using Guangzhou Laboratory presentation templates. Use when the user
  asks to generate a Guangzhou Laboratory PPT, project application, technical
  report, research presentation, or mentions gzlab-ppt-skills.
---
